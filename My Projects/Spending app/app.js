...
const StorageCtrl = (function(){
    ...
    return {
        storeItem: function(item){
            let items;
            // Check if any items in LS: null nothing in storage
...
// Item controller - invoke with () at end
const ItemCtrl = (function(){
    // Item constructor - set this.property to property being passed in
    ...
    const data = {
        // items: [
        //     // {id: 0, name: 'Steak Dinner', cost: 1200},
        //     // {id: 1, name: 'Cookie', cost: 400},
        //     // {id: 2, name: 'Eggs', cost: 300}
        // ], // array, private and not accessible
    ...
    return {
        ...
        getTotalCost: function() {
            ...
            // Loop through items and add cost
            data.items.forEach(function(item){
                total += item.cost;
            });
    ...
    return {
        populateItemList: function(items){
            ...
            items.forEach(function(item){
                ...
                <strong>${item.name}: </strong> <em>$${item.cost.toFixed(2)}</em>
        ...
        addListItem: function(item){
            ...
            li.id = `item-${item.id}`;
            // Add HTML
            li.innerHTML = `<strong>${item.name}: </strong> <em>$${item.cost.toFixed(2)}</em>
            <a href="#" class="secondary-content">
                <i class="edit-item fa fa-pencil"></i>
            </a>`;
            // Insert item
        ...
        updateListItem: function(item){
            ...
            listItems.forEach(function(listItem){
                ...
                if(itemID === `item-${item.id}`){
                    document.querySelector(`#${itemID}`).innerHTML = `<strong>${item.name}: </strong> <em>$${item.cost.toFixed(2)}</em>
                    <a href="#" class="secondary-content">
                        <i class="edit-item fa fa-pencil"></i>
                    </a>`;
                }
